...
const TrashBox: FC<Props> = (): JSX.Element => {
  ...
  const onRestore = (e: MouseEvent<HTMLDivElement, MouseEvent>, documentId: Id<'documents'>) => {
    e.stopPropagation()
  ...
  const onRemove = (e: MouseEvent<HTMLDivElement, MouseEvent>, documentId: Id<'documents'>) => {
